...
| ------------------------------------------------------------- | ----------- | --------------------------------- | ---------------------------------------- |
| requirements, prd, ux_design, architecture, stories, database | 文档类      | `references/document-review.md`   | `docs/reviews/phase-{NN}-{phase_key}.md` |
...
| 3    | `ux_design`    | UX 设计    | Bella (Designer) | `step-02.5-ux-design.md`  | 文档类      |
| 4    | `architecture` | 系统架构   | Bob (Architect)  | `step-03-architecture.md` | 文档类      |
| 5    | `stories`      | 任务分解   | Charlie (Lead)   | `step-04-stories.md`      | 文档类      |
| 6    | `database`     | 数据库设计 | Bob (Architect)  | `step-05-database.md`     | 文档类      |
| 7    | `backend`      | 后端开发   | David (Backend)  | `step-06-backend.md`      | 代码类      |
| 8    | `frontend`     | 前端开发   | Eve (Frontend)   | `step-07-frontend.md`     | 代码类      |
| 9    | `testing`      | 测试       | Frank (QA)       | `step-08-testing.md`      | 测试阶段    |
| 10   | `review`       | 代码审查   | Grace (Reviewer) | `step-09-review.md`       | 代码类      |
| 11   | `deployment`   | 部署       | Henry (DevOps)   | `step-10-deployment.md`   | 部署阶段    |
